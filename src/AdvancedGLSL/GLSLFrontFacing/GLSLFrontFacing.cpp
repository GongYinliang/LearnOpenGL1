...
#include "AdvancedGLSL/GLSLFrontFacing/Shader.h"
#include "AdvancedGLSL/GLSLFrontFacing/Model.h"
#include "AdvancedGLSL/GLSLFrontFacing/Camera.h"
...
int main()
{
    ...
    // --------------------
    std::string windowTitle = "尘海折柳:【菜鸟驿站:LearnOpenGL提高—GLSLFrontFacing】";
