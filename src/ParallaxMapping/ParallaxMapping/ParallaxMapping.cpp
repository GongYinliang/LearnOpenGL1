...
#include "ParallaxMapping/ParallaxMapping/Shader.h"
#include "ParallaxMapping/ParallaxMapping/Model.h"
#include "ParallaxMapping/ParallaxMapping/Camera.h"
...
int main()
{
    ...
    // --------------------
    std::string windowTitle = "尘海折柳:【菜鸟驿站:LearnOpenGL提高—ParallaxMapping】";
    ...
    // -------------------------
    Shader shader("../../../shaders/ParallaxMapping/ParallaxMapping/parallax_mapping.vs", "../../../shaders/ParallaxMapping/ParallaxMapping/parallax_mapping.fs");
