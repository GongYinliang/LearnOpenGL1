...
#include "ParallaxMapping/SteepParallaxMapping/Shader.h"
#include "ParallaxMapping/SteepParallaxMapping/Model.h"
#include "ParallaxMapping/SteepParallaxMapping/Camera.h"
...
int main()
{
    ...
    // --------------------
    std::string windowTitle = "尘海折柳:【菜鸟驿站:LearnOpenGL提高—SteepParallaxMapping】";
    ...
    // -------------------------
    Shader shader("../../../shaders/ParallaxMapping/SteepParallaxMapping/parallax_mapping.vs", "../../../shaders/ParallaxMapping/SteepParallaxMapping/parallax_mapping.fs");
