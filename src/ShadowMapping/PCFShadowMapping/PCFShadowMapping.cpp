...
#include "ShadowMapping/PCFShadowMapping/Shader.h"
#include "ShadowMapping/PCFShadowMapping/Model.h"
#include "ShadowMapping/PCFShadowMapping/Camera.h"
...
int main()
{
	...
	// --------------------
	std::string windowTitle = "尘海折柳:【菜鸟驿站:LearnOpenGL提高—PCFShadowMapping】";
	...
	// -------------------------
	Shader shader("../../../shaders/ShadowMapping/PCFShadowMapping/shadow_mapping.vs", "../../../shaders/ShadowMapping/PCFShadowMapping/shadow_mapping.fs");
	Shader simpleDepthShader("../../../shaders/ShadowMapping/PCFShadowMapping/shadow_mapping_depth.vs", "../../../shaders/ShadowMapping/PCFShadowMapping/shadow_mapping_depth.fs");
	Shader debugDepthQuad("../../../shaders/ShadowMapping/PCFShadowMapping/debug_quad_depth.vs", "../../../shaders/ShadowMapping/PCFShadowMapping/debug_quad_depth.fs");
	float planeVertices[] = {
